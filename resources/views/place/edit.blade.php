...
{{-- Web site Title --}}
@section('title') Edit Your Place :: @parent
@stop
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                    ...
                    {!! Form::model($place, ['method' => 'PATCH', 'action' => ['PlaceController@update', $place->id],'files'=>true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::submit('Edit Place', ['class' => 'btn btn-primary form-control']) !!}
                </div>
                    {!! Form::close() !!}
            </div>
        </div>
